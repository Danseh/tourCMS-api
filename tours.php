            ...
            <a href="<?php print $tour->tour_url; ?>"><span class="dummy"></span><span class="dummy-upper-right"></span></a>
            	<div class="card-body">
					...
					<span class="tourcms-badge-location-horizontal"> 
						<a href="https://wordpress.tourcms.com/tours-by-location/<?php print $tour->location;?>/" rel="tag"><?php print $tour->location;?></a>
					</span>
                	</div>
...
<!--              <p class="card-text"><i class="fas fa-history" style=""></i> <b>Duration:</b> 4 hours</p>-->
            ...
            <div class="card-footer bg-transparent">
              ...
              <p class="tourcms-card-text tour-mobile-footer-right" style=""><a href="<?php print $tour->tour_url; ?>">Book now <span class='fromprice'>from &#8364;<?php print $tour->from_price; ?></span></a><br></p>
            </div>
          </div>
</div>
